<template>
	<button @click="connectWallet" class="flex justify-center px-4 bg-pink-600 py-2 text-sm font-medium rounded-full opacity-100 shadow-lg text-gray-200 bg-gradient-to-r from-purple-500 to-pink-600 hover:from-pink-600 hover:to-purple-500">
		<span v-if="this.$wallet.isConnected" class="flex items-center">
