...
<!--&lt;!&ndash;					<h2 class="text-base text-indigo-600 font-semibold tracking-wide uppercase">Transactions</h2>&ndash;&gt;-->
<!--					<p class="mt-2 text-3xl leading-8 font-extrabold tracking-tight text-gray-200 sm:text-4xl">-->
<!--						About the Parasol Finance Project-->
<!--					</p>-->
...
<!--							<dt>-->
<!--								<div class="absolute flex items-center justify-center h-12 w-12 rounded-md bg-indigo-500 text-white">-->
<!--									&lt;!&ndash; Heroicon name: outline/lightning-bolt &ndash;&gt;-->
<!--									<svg class="h-6 w-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">-->
