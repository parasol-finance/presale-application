	...
	<section class="mt-20 px-6">
		<article class="p-10 max-w-xl mx-auto sm:rounded-lg flex-flex-col-items-center">
			...
			<div class="flex flex-col items-center">
				<button v-if="isTelegramConnected" @click="confirm" class="flex items-center justify-center text-xl px-6 bg-pink-600 py-2 text-sm font-medium rounded-full opacity-100 shadow-lg text-gray-200 bg-gradient-to-r from-purple-500 to-pink-600 hover:from-pink-600 hover:to-purple-500">
				...
				<vue-telegram-login
					v-else
					mode="callback"
					telegram-login="ParasolFinanceBot"
					:userpic="false"
...
export default {
	...
	methods: {
		handleTelegramConnection: function (user) {
